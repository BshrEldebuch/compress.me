...
class MainWindow():
    ...
    def set_progress_label_text(self):
        if (self.check_for_completion is None):
            ...
            self.progress_label_text.set("Transfer Completed \n Selected folder {}".format(self.input_path)) 
        else:
            self.progress_label_text.set("Transfer Failed, please try again... \n Selected Folder {}".format(self.input_path))
    ...
    def create_confirmation_button(self):
        ...
        self.confirmation_button.pack(padx=10,pady=10)
